...
const ProfileInterest = require('../controller/ProfileInterest');
...
module.exports = [
    ...
    {// GET
        method: 'GET',
        path: '/profile/{id}/interestedArea',
        handler: async (req, res) => {
            let result;
            try {
                result = await ProfileInterest(req.getDb()).listInterestedArea(req.params.id);
            } catch(err) {
                throw err;
            }
            return result
