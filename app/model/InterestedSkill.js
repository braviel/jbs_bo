...
module.exports = function(sequelize, DataTypes) {
    ...
    InterestedSkill.associate = function(models)  {
        ...
        models.InterestedSkill.belongsTo(models.InterestedArea, {foreignKey: 'AreaCode', onDelete: 'RESTRICT'});
        models.InterestedArea.hasMany(models.InterestedSkill, {foreignKey: 'AreaCode', onDelete: 'RESTRICT'});        
    }
